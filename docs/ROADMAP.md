...
5. Design separately isolated native runtimes for Java, C/C++, Go, Rust, Kotlin and Swift.
6. Add async/event-loop and framework state/rendering adapters.
7. Improve accessibility, editor behavior and mobile visualizations.

A runtime is available only after it has tests, clear capability labels, cancellation, resource limits and security review.
